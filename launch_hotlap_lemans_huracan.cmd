@echo off
REM ===============================================================
REM  ONE-CLICK: LE MANS HOTLAP · LAMBORGHINI HURACAN GT3 · LMGT3
...
set "PRESET=%ACDOC%\cfg\hotlap_lemans_huracan.ini"
...
echo  =============================================================
echo  [LE MANS HOTLAP · LAMBORGHINI HURACAN GT3 · LMGT3]
echo.
