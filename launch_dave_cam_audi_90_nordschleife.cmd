@echo off
REM ===============================================================
REM  ONE-CLICK: DAVE CAM TRIBUTE · AUDI 90 GTO · NORDSCHLEIFE
...
set "PRESET=%ACDOC%\cfg\race_dave_cam_audi_90_nordschleife.ini"
...
echo  =============================================================
echo  [DAVE CAM TRIBUTE · AUDI 90 GTO · NORDSCHLEIFE]
echo.
