@echo off
REM ===============================================================
REM  ONE-CLICK: MOTORLAND ARAGON HOTLAP 2026 — MERCEDES-AMG W16 (ANTONELLI)
REM  - Backs up cfg/race.ini, installs the preset, fires Crew Chief,
REM    runs acs.exe, and kills CC when AC exits.
REM  - No saved Pablo setup yet; FIXED_SETUP=0 leaves the
REM    garage open so any setup can be chosen in-game.
REM ===============================================================
setlocal enableextensions

set "ACDOC=%USERPROFILE%\Documents\Assetto Corsa"
set "ACINSTALL=F:\SteamLibrary\steamapps\common\assettocorsa"
set "PRESET=%ACDOC%\cfg\hotlap_madrid_2026.ini"
...
echo  =============================================================
echo  [MOTORLAND ARAGON HOTLAP 2026 - MERCEDES-AMG W16]
echo.
