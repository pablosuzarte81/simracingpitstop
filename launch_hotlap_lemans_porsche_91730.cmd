@echo off
REM ===============================================================
REM  ONE-CLICK: LE MANS HOTLAP · PORSCHE 917/30 SPYDER · 1200 BHP CAN-AM
...
set "PRESET=%ACDOC%\cfg\hotlap_lemans_porsche_91730.ini"
...
echo  =============================================================
echo  [LE MANS HOTLAP · PORSCHE 917/30 SPYDER · 1200 BHP CAN-AM]
echo.
