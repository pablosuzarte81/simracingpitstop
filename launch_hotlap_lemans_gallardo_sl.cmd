@echo off
REM ===============================================================
REM  ONE-CLICK: LE MANS HOTLAP · LAMBORGHINI GALLARDO SL STEP3 · 1200 BHP TUNER
...
set "PRESET=%ACDOC%\cfg\hotlap_lemans_gallardo_sl.ini"
...
echo  =============================================================
echo  [LE MANS HOTLAP · LAMBORGHINI GALLARDO SL STEP3 · 1200 BHP TUNER]
echo.
