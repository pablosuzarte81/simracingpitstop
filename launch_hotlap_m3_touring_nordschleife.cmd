@echo off
REM ===============================================================
REM  ONE-CLICK: M3 TOURING GT3 · NORDSCHLEIFE 24h LAYOUT (solo hotlap)
REM  - You drive the Schubert Motorsport #81 M3 Touring GT3 EVO (2026 N24 SPX winner).
REM  - Track: Nordschleife 24h 2024 layout (same as the GT3 duels).
REM  - Solo hotlap, ghost on.
REM ===============================================================
setlocal enableextensions

set "ACDOC=%USERPROFILE%\Documents\Assetto Corsa"
set "ACINSTALL=F:\SteamLibrary\steamapps\common\assettocorsa"
set "PRESET=%ACDOC%\cfg\hotlap_m3_touring_nordschleife.ini"
...
echo  =============================================================
echo  [M3 TOURING GT3 - NORDSCHLEIFE 24h LAYOUT (HOTLAP)]
echo.
