@echo off
REM ===============================================================
REM  ONE-CLICK: LE MANS HOTLAP · CADILLAC V-SERIES.R · LMDh HYPERCAR
...
set "PRESET=%ACDOC%\cfg\hotlap_lemans_cadillac.ini"
...
echo  =============================================================
echo  [LE MANS HOTLAP · CADILLAC V-SERIES.R · LMDh HYPERCAR]
echo.
