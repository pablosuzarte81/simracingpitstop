@echo off
REM ===============================================================
REM  ONE-CLICK: LE MANS HOTLAP · BMW M HYBRID V8 · LMDh HYPERCAR
...
set "PRESET=%ACDOC%\cfg\hotlap_lemans_bmw_mhybrid.ini"
...
echo  =============================================================
echo  [LE MANS HOTLAP · BMW M HYBRID V8 · LMDh HYPERCAR]
echo.
