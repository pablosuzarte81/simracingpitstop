@echo off
REM ===============================================================
REM  ONE-CLICK: VERSTAPPEN vs ANTONELLI · NORD 24H (INVERTED)
REM  - You drive the Red Bull RB21 #1 against the Mercedes W16 #12 AI.
...
set "PRESET=%ACDOC%\cfg\duel_verstappen_vs_antonelli_nord.ini"
...
echo  =============================================================
echo  [VERSTAPPEN vs ANTONELLI · NORD 24H · INVERTED]
echo.
