@echo off
REM ===============================================================
REM  ONE-CLICK: N24 GRID HOTLAP — #7 KONRAD MOTORSPORT LAMBORGHINI HURACAN GT3 EVO2
...
set "PRESET=%ACDOC%\cfg\hotlap_n24_abt_sportsline.ini"
...
echo  =============================================================
echo  [N24 GRID HOTLAP - #7 KONRAD MOTORSPORT LAMBORGHINI HURACAN GT3 EVO2]
echo.
