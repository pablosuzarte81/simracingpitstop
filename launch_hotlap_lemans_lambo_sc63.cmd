@echo off
REM ===============================================================
REM  ONE-CLICK: LE MANS HOTLAP · LAMBORGHINI SC63 · LMDh HYPERCAR
...
set "PRESET=%ACDOC%\cfg\hotlap_lemans_lambo_sc63.ini"
...
echo  =============================================================
echo  [LE MANS HOTLAP · LAMBORGHINI SC63 · LMDh HYPERCAR]
echo.
