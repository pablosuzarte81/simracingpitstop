@echo off
REM ===============================================================
REM  ONE-CLICK: HAASE VS VERSTAPPEN - NIGHT + HEAVY RAIN (inverted 1v1)
REM  - You drive Haase's Audi R8 GT3 #16, Verstappen Mercedes is the AI rival.
REM ===============================================================
setlocal enableextensions

set "ACDOC=%USERPROFILE%\Documents\Assetto Corsa"
set "ACINSTALL=F:\SteamLibrary\steamapps\common\assettocorsa"
set "PRESET=%ACDOC%\cfg\race_haase_1v1_night_rain.ini"
...
echo  =============================================================
echo  [HAASE VS VERSTAPPEN - NIGHT + RAIN (INVERTED 1v1)]
echo.
