@echo off
REM ===============================================================
REM  ONE-CLICK: MARCH 701 · STEWART · NORDSCHLEIFE 24h LAYOUT (solo hotlap)
REM  - You drive Jackie Stewart in the RSS March 701 (1970 F1).
REM  - Track: Nordschleife 24h 2024 layout (same as the GT3 duels + Vettel RB7).
...
set "PRESET=%ACDOC%\cfg\hotlap_march701_nordschleife.ini"
...
echo  =============================================================
echo  [MARCH 701 - STEWART - NORDSCHLEIFE 24h LAYOUT (HOTLAP)]
echo.
